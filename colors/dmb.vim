...
let s:darkred		= exists("g:darkred") ? g:darkred :	    '#FF69b4' " changed to hot pink
...
let s:darkgrey		= exists("g:darkgrey") ? g:darkgrey :	    '#32CD32' " change to lime green
...
let s:cyan		= exists("g:cyan") ? g:cyan :		    '#32CD32' " changed to lime green
